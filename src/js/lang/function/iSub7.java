...
/**
 * Represents a 7 input subroutine that can be called.
 ...
 */
public interface iSub7<TA, TB, TC, TD, TE, TF, TG> extends iProc {
	
	/* static data */
	/** Signature of this interface. */
	static MethodType TYPE = iProc.type(false, 7);
	...
	default Object call(Object... a) {
		accept((TA)a[0], (TB)a[1], (TC)a[2], (TD)a[3], (TE)a[4], (TF)a[5], (TG)a[6]);
		return null;
	}
}
